...
help:
	...
	@echo "  make check-standards       Template drift check (fail on diverged; stale warns)"
	@echo "  make standards-materialize Copy standards/ → .cursor/ managed paths"
	@echo "  make standards-upgrade     Bump submodule pin + re-materialize (VERSION=1.1.3)"
	@echo ""
