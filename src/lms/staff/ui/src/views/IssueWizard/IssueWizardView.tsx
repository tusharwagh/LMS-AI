...
import { useIssueWizardController } from "@/controllers/useIssueWizardController";
import wizardStyles from "./IssueWizard.module.css";

/** View — issue wizard presentation (MVC). */
export function IssueWizardView() {
  const wizard = useIssueWizardController();
  const {
    state,
    card,
    setCard,
