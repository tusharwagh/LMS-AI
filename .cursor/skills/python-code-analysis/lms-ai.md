...
Supplement to [SKILL.md](SKILL.md). Commands and paths for **this repository**.
...
| Topic | Path |
|-------|------|
| Security tests & headers | `.cursor/rules/security-and-hardening.md` |
...
| SonarQube quality rules | `.cursor/rules/sonarqube-quality.md` |
