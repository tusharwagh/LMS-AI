...
**LMS-AI project commands and markers:** [lms-ai.md](lms-ai.md)

**Related craft skills:** [clean-code-ddd-python](../clean-code-ddd-python/SKILL.md), [clean-code-ddd-lms-ai](../clean-code-ddd-lms-ai/SKILL.md)
...
Before push, run the same gates CI runs (see [lms-ai.md](lms-ai.md) for LMS-AI):
...
Cross-reference: [.cursor/rules/sonarqube-quality.md](../../rules/sonarqube-quality.md) for Sonar-aligned complexity, duplication, and security hotspot rules.
...
- LMS-AI Makefile targets, markers, CI: [lms-ai.md](lms-ai.md)
