...
**Project-specific agent API addendum:** see [api-and-interface-design-lms-ai.md](../../lms-ai/rules/api-and-interface-design-lms-ai.md) for LMS-AI `/api/v1/agent/issue/*` contracts.