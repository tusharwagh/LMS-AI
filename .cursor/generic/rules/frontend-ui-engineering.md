...
**Project-specific UI addendum:** see [frontend-ui-engineering-lms-ai.md](../../lms-ai/rules/frontend-ui-engineering-lms-ai.md) when working on the LMS-AI staff desk.